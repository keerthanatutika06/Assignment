  ...
  renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'recommended':
        return (
          <p className="content">
            I would recommend the following products to you based on your
            previous purchases:
            <br />
            <br />
            <b>1. Salesforce CRM</b>
            <br />
      ...
      <div className="app-container">
        <div className="section1">
          ...
          <div className="main-content">
            ...
            <div className="button-content">{this.renderContent()}</div>
          </div>
        </div>
        ...
        <div className="section2">
          ...
          <div className="gallery-section-content">
            <div className="nav-bar-buttons-container">
              <button disabled className="gallery-button">
              ...
              <div className="add-image-buttons-container">
                ...
                <button
                  ...
                  onClick={() => this.scrollImages('left')}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                ...
                <button
                  aria-label="button"
                  className="left-arrow-button"
                  onClick={() => this.scrollImages('right')}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
