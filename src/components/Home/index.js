...
class Home extends Component {
    ...
    return(
        ...
        <div className="nav-bar-buttons-container">
            <button disabled className="gallery-button"><span className="gallery-label">Gallery</span></button>
    ...
    />
            ...
            <button className="left-arrow-button" onClick={() => this.scrollImages('left')}>
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="left-arrow-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
